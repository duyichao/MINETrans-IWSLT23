...
from fairseq.models.transformer import TransformerModel, TransformerConfig, DEFAULT_MIN_PARAMS_TO_WRAP, \
    DEFAULT_MAX_TARGET_POSITIONS
from fairseq.modules.transformer_sentence_encoder import init_bert_params

from .hub_interface import BARTHubInterface
from ..lstm import DEFAULT_MAX_SOURCE_POSITIONS
...
class BARTModel(TransformerModel):
    ...
    #     default=5000, metadata={"help": "dont finetune wav2vec for this many updates"}
    # )
...
def bart_large_architecture(args):
    ...
    args.w2v_freezing_updates = getattr(args, "encoder_freezing_updates", None)
...
@register_model_architecture("bart", "bart_large_t2u")
def bart_large_t2u_architecture(args):
