...
@register_model_architecture("transformer", "1024")
...
@register_model_architecture("transformer", "transformer_text2unit_large")
def transformer_text2unit(args):
    # base_architecture(args)
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 1024)
...
@register_model_architecture("transformer", "transformer_text2unit_large_pre_norm")
def transformer_text2unit_pre_norm(args):
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", True)
    args.decoder_normalize_before = getattr(args, "decoder_normalize_before", True)
    args.encoder_learned_pos = getattr(args, "encoder_learned_pos", True)
    args.decoder_learned_pos = getattr(args, "decoder_learned_pos", True)
    transformer_text2unit(args)