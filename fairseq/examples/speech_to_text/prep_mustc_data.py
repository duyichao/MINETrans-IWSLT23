    ...
    def __init__(self, root: str, lang: str, split: str) -> None:
        ...
        for wav_filename, _seg_group in groupby(segments, lambda x: x["wav"]):
            ...
            for i, segment in enumerate(seg_group):
                ...
                _id = f"{wav_path.stem}_{str(i).zfill(4)}"
                self.data.append(
                    (
                        wav_path.as_posix(),
                        offset,
...
def process(args):
    ...
    for lang in MUSTC.LANGUAGES:
        ...
        audio_root = cur_root / ("iwslt_wav" if args.use_audio_input else "iwslt_fbank80")
        ...
        # zip_path = f"{audio_root.as_posix()}.zip"
        ...
        for split in MUSTC.SPLITS:
            ...
            for _, _, src_utt, tgt_utt, speaker_id, utt_id in tqdm(dataset):
                ...
                manifest["audio"].append("/apdcephfs/share_916081/iwslt2023/data/iwslt_s2t_test/iwslt_wav" + f"/{utt_id}.wav")
